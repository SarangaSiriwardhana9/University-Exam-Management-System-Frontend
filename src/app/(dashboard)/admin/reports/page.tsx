...
import { useDeleteReport, useDownloadReport } from '@/features/reports/hooks/use-report-mutations'
...
const ReportsPage = () => {
  ...
  const [deletingReport, setDeletingReport] = useState<ReportResult | null>(null)

  const { data, isLoading } = useReportsHistoryQuery()
        ...
        <AlertDialog open={!!deletingReport} onOpenChange={() => setDeletingReport(null)}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                This will permanently delete the report <strong>{deletingReport?.title}</strong> from the system.
