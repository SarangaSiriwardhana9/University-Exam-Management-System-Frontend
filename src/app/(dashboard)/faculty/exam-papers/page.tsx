// src/app/(dashboard)/faculty/exam-papers/page.tsx
'use client'
...
const ExamPapersPage = () => {
  ...
  const { data, isLoading } = useExamPapersQuery({ myPapers: true })
  ...
  return (
    <RoleGuard allowedRoles={[USER_ROLES.FACULTY, USER_ROLES.ADMIN]}>
      <div className="space-y-6">
        ...
        <AlertDialog open={!!deletingPaper} onOpenChange={() => setDeletingPaper(null)}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                This will permanently delete the exam paper &ldquo;{deletingPaper?.paperTitle}&ldquo;.
        ...
        <AlertDialog open={!!finalizingPaper} onOpenChange={() => setFinalizingPaper(null)}>
          <AlertDialogContent>
            <AlertDialogHeader>
              <AlertDialogTitle>Finalize Exam Paper?</AlertDialogTitle>
              <AlertDialogDescription>
                This will lock the exam paper &ldquo;{finalizingPaper?.paperTitle}&#34; and prevent any further edits.
                Once finalized, the paper cannot be modified. Are you sure you want to proceed?
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
              <AlertDialogCancel>Cancel</AlertDialogCancel>
